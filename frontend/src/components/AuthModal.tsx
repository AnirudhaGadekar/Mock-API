...
export const AuthModal: React.FC = () => {
    const { authModalState, hideAuthModal, login, signup } = useAuth();
                ...
                <div className="p-8">
                    <div className="grid grid-cols-2 gap-4 mb-8">
                        <button
                            ...
                            className="flex items-center justify-center gap-2 bg-slate-800 hover:bg-slate-700 text-white py-2.5 rounded-lg border border-slate-700 transition-all active:scale-95"
                        >
                            <Github size={18} />
                            <span>GitHub</span>
                        </button>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-lg shadow-lg shadow-indigo-600/20 transition-all active:scale-95"
                        >
